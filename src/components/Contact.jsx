  ...
  const faqs = [
    {
      ...
      answer: "We offer comprehensive interior design services for kitchens, wardrobes and bathrooms. Our services range from space planning to full project management."
    },
    {
