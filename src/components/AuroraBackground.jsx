...
//   ...props
// }) => {
//   // Base classes for the outer div
//   const baseClasses =
...
//   // Add radial gradient class conditionally
//   const radialGradientClasses = showRadialGradient
//     ? "[mask-image:radial-gradient(ellipse_at_100%_0%,black_10%,var(--transparent)_70%)]"
//     : "";

//   const finalGradientClassName = `${gradientClasses} ${radialGradientClasses}`.trim();

//   return (
//     <main>
//       <div className={outerClassName} {...props}>
//         <div className="absolute inset-0 overflow-hidden">
//           <div className={finalGradientClassName}></div>
//         </div>
//         {children}
//       </div>
//     </main>
